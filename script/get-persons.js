const links = document.querySelectorAll('.item-persons__btn');
...
const renderDates = (dates) => {
    ...
    const load = () => {
        ...
        img.src = questions[indexOfQuestion].img;
...
const getData = (value) => {
    fetch('db/persons.json')
        ...
        .then((data) => {
            ...
            if (window.location.pathname !== 'History-ZNO/quiz-persons.html') {
                window.location.href = 'History-ZNO/quiz-persons.html'
            } else {
                renderAccents(array)
            }
        })
...
if (localStorage.getItem('dates') && window.location.pathname === 'History-ZNO/quiz-persons.html') {
